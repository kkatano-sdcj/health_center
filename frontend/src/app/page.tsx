              ...
              {features.map((feature) => {
                ...
                return (
                  <Link key={feature.href} href={feature.href}>
                    <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-200 p-6 h-full border border-gray-100 hover:border-gray-200 group cursor-pointer">
        ...
        <section className="bg-gradient-to-r from-blue-600 to-purple-600 py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex gap-4 justify-center">
              ...
              <Link
                href="/qachat"
                className="inline-flex items-center gap-2 px-8 py-4 bg-purple-700 bg-opacity-50 text-white rounded-lg font-medium hover:bg-opacity-70 transition-colors border border-white border-opacity-30"
              >
